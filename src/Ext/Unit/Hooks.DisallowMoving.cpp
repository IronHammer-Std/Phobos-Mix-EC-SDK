...
DEFINE_HOOK(0x741AA7, UnitClass_Assign_Destination_DisallowMoving, 0x6)
{
	...
	return TechnoExt::CannotMove(pThis) || TechnoExt::HasAttachmentLoco(pThis) ? 0x743173 : 0;
}
...
DEFINE_HOOK(0x743B4B, UnitClass_Scatter_DisallowMoving, 0x6)
{
	...
	return TechnoExt::CannotMove(pThis) || TechnoExt::HasAttachmentLoco(pThis) ? 0x74408E : 0;
}
